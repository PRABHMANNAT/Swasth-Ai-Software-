...
const PricingCard = ({
  title, subtitle, price, priceSuffix, ctaText,
  features, extraFeatures, badge, featured = false,
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Extra features with plus divider */}
        {extraFeatures && extraFeatures.length > 0 && (
          <>
            <PlusDivider />
            <div>
              {extraFeatures.map((f, i) => <Feature key={i} text={f} accent />)}
            </div>
          </>
        )}
      </div>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            marginBottom: 20, borderRadius: 999,
            padding: "6px 16px",
            ...
            <span style={{
              ...
              background: "#fff", boxShadow: "0 0 10px rgba(255,255,255,0.8)",
          ...
          <p style={{
            ...
            Choose the plan that suits your healthcare needs. No hidden fees.
          </p>
        </div>
        ...
        <div style={{
          ...
          <PricingCard
            title="Swasth Basic"
            subtitle="Essential health tools for everyone"
            price="₹0"
        ...
        <p style={{
          ...
          No credit card required · Cancel anytime · ABDM & AES-256 compliant
        </p>
      </div>
    </section>
  )
